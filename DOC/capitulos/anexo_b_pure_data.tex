...
Pure Data (Pd) es un entorno de programación visual de código abierto desarrollado originalmente por Miller Puckette en los años 90. Es ampliamente utilizado por músicos, artistas visuales e investigadores para la creación interactiva de música por ordenador y obras multimedia. A diferencia de los lenguajes de programación tradicionales basados en texto, Pd permite a los usuarios desarrollar algoritmos conectando objetos gráficos en un "lienzo" o \textit{patch}.

\section{Programación Visual en Pure Data}

En Pd, un programa se construye instanciando diferentes cajas u "objetos" y conectándolos mediante "cables". Cada objeto realiza una función específica, como generar una onda matemática, sumar dos números o aplicar un filtro a una señal de audio.
...
Desde la perspectiva de las herramientas de generación automática desarrolladas en este proyecto, este concepto de encapsulación es fundamental. Un sub-módulo en Pure Data equivale directamente al concepto arquitectónico de \textbf{"Máquina"} definido en nuestros lenguajes DSL. Del mismo modo, esta misma equivalencia semántica se mapea a \textbf{clases} o \textbf{métodos} cuando el código objetivo es un lenguaje de texto estructurado como JavaScript u otros lenguajes soportados.
...
Pd-l2ork es multiplataforma y puede descargarse de forma gratuita desde su sitio web oficial o directamente desde su repositorio de lanzamientos (\url{https://github.com/agraef/purr-data/releases}). La instalación sigue el proceso estándar de cualquier aplicación según el sistema operativo (Windows, macOS o Linux).
