...
If a grammar in `dsl/` changes (validation, structure, etc.), you MUST:
1. **Sync Docs**: Update technical reference markdown manuals of `dsl/`, these manuals are in folder `dsl/REGLAS_DSLs`.
