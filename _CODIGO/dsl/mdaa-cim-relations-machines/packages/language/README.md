...
- [src/mda-cim-relations.langium](src/mda-cim-relations.langium) -  The grammar definition of your language
- [src/mda-cim-relations-module.ts](src/mda-cim-relations-module.ts) - The dependency injection module of your language implementation. Use this to register overridden and added services.
- [src/mda-cim-relations-validator.ts](src/mda-cim-relations-validator.ts) - An example validator. You should change it to reflect the semantics of your language.
...
- [src/syntaxes/mda-cim-relations.monarch.ts](src/syntaxes/mda-cim-relations.monarch.ts) - Monarch based syntax highlighting instructions.
- [syntaxes/mda-cim-relations.tmLanguage.json](syntaxes/mda-cim-relations.tmLanguage.json) - Textmate based syntax highlighting instructions.
