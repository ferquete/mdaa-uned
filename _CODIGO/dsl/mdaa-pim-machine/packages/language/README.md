...
- [src/mda-audio-pim-machine.langium](src/mda-audio-pim-machine.langium) -  The grammar definition of your language
- [src/mda-audio-pim-machine-module.ts](src/mda-audio-pim-machine-module.ts) - The dependency injection module of your language implementation. Use this to register overridden and added services.
- [src/mda-audio-pim-machine-validator.ts](src/mda-audio-pim-machine-validator.ts) - An example validator. You should change it to reflect the semantics of your language.
...
- [src/syntaxes/mda-audio-pim-machine.monarch.ts](src/syntaxes/mda-audio-pim-machine.monarch.ts) - Monarch based syntax highlighting instructions.
- [syntaxes/mda-audio-pim-machine.tmLanguage.json](syntaxes/mda-audio-pim-machine.tmLanguage.json) - Textmate based syntax highlighting instructions.
