...
import type { MdaAudioPimRelationsMachinesServices } from './mda-audio-pim-relations-machines-module.ts';
 ...
 /**
  * Registra las reglas de validación en el ecosistema Langium para el DSL de PIM Relations.
  */
 ...
 /**
  * Validador estructural y semántico para las relaciones de conexión a nivel de PIM.
  */
 export class MdaAudioPimRelationsMachinesValidator {
 
     /**
      * Valida a nivel global el documento, comprobando la validez de la descripción y la unicidad de los IDs.
      */
     ...
     /**
      * Valida las propiedades de cada enlace de red individual (UUIDs estrictos y descripciones).
      */
