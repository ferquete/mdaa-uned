...
/**
 * Editor central del CIM (Computational Independent Model).
 * Permite definir las relaciones globales y de alto nivel entre diferentes máquinas del proyecto.
 */
...
/**
 * Lista de máquinas disponibles en el proyecto, mapeadas para su uso en selectores.
 * @returns {Array} Lista con ID, nombre y capacidades de entrada/salida externa de cada máquina.
 */
...
/**
 * Obtiene las máquinas que pueden servir como origen (tienen salida externa).
 * @param {string} destId ID del destino actual para evitar autoconexiones.
 * @returns {Array} Lista de máquinas válidas.
 */
...
/**
 * Obtiene las máquinas que pueden servir como destino (tienen entrada externa).
 * @param {string} sourceId ID del origen actual para evitar autoconexiones.
 * @returns {Array} Lista de máquinas válidas.
 */
...
/**
 * Calcula los errores de validación de las relaciones definidas.
...
/**
 * Indica si el formulario del editor es válido y no tiene errores.
 */
...
/**
 * Añade una nueva relación vacía a la lista.
 */
const addRelation = () => {
...
/**
 * Elimina una relación específica por su índice.
 * @param {number} index Índice de la relación a eliminar.
 */
...
/**
 * Guarda los cambios realizados en el CIM.
 */
