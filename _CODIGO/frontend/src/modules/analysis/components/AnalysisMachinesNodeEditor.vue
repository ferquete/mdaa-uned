...
/**
 * Componente para la edición de subnodos (generadores/modificadores)
 * dentro de una máquina de análisis CIM.
 */
...
/**
 * Realiza la validación en tiempo real del formulario del nodo.
 * @returns {Record<string, string>} Objeto con los errores de validación.
 */
...
/** Indica si el formulario es completamente válido */
const isFormValid = computed(() => Object.keys(validationErrors.value).length === 0)

/**
 * Descompone el ID del nodo actual para determinar si es nuevo o existente,
 * su tipo y la máquina a la que pertenece.
 */
...
/** Observa los cambios en el nodo seleccionado para cargar sus datos en el formulario */
...
/** Opciones disponibles para interconectar con otros elementos dentro de la misma máquina */
...
/**
 * Guarda los cambios realizados en el nodo actual.
...
/** Observador que marca el estado como "sin guardar" si hay cambios válidos */
...
/**
 * Alterna el estado de una conexión "sendTo" hacia otra máquina o elemento.
 * @param {string} idRef Identificador de referencia de destino.
 */
