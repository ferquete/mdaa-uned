...
/**
 * Propiedades del modal de máquina PIM.
 */
interface Props {
  ...
  confirmText: string
  /** Datos iniciales en caso de edición (opcional) */
  initialData?: {
    name: string
    description: string
 ...
 * @returns {string} Mensaje de error si es inválido, vacío en caso contrario.
 */
...
/**
 * Valida la descripción ingresada.
 * @returns {string} Mensaje de error si es inválido, vacío en caso contrario.
 */
...
/**
 * Indica si el formulario es válido para su envío.
 */
...
/**
 * Observador para reiniciar o cargar datos cuando se muestra el modal.
 */
...
/**
 * Alterna la selección de una máquina CIM como referencia.
 * @param {string} uuid Identificador de la máquina CIM.
 */
...
/**
 * Maneja la confirmación del formulario y emite los datos correspondientes.
 */
const handleConfirm = () => {
  if (isValid.value) {
...
/**
 * Manejador global para confirmación mediante teclado (Enter).
...
/**
 * Mapeo de IDs de máquinas de análisis a sus nombres para mostrar en la interfaz.
 */
