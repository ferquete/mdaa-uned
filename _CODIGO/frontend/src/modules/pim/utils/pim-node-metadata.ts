...
export const PIM_MODIFIABLE_PARAMS: Record<string, string[]> = {
  ...
  sample: ['file', 'gain', 'pan', 'loop'],
  lfo: ['waveform', 'rate', 'amplitude', 'phase', 'sync'],
  envelope: ['attack', 'decay', 'sustain', 'release', 'delay', 'hold', 'curve'],
  frequency_filter: ['cutoff', 'resonance', 'filterType', 'slope'],
  reverb: ['roomSize', 'damping', 'decayTime', 'dryWet'],
  delay: ['delayTime', 'feedback', 'lowPassCutoff', 'highPassCutoff', 'dryWet'],
  distortion: ['drive', 'tone', 'outputLevel', 'distType'],
