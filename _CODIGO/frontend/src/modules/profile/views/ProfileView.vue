 ...
 * Permite visualizar y editar la información básica del usuario actual (nombre y apellidos),
 * comunicándose con el store de usuario y el backend.
 */
...
/** Comprueba que todos los campos modificables del formulario sean válidos */
 ...
 * Si no existen en el store local, intenta sincronizar con el backend.
 */
onMounted(async () => {
  if (!userStore.user) {
 ...
 * Muestra notificaciones de éxito o error, y regresa a la vista anterior si es exitoso.
 */
...
/** Navega hacia la vista anterior en el historial del navegador */
