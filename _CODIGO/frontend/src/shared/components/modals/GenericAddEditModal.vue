...
/**
 * Propiedades del modal genérico de adición/edición.
 */
interface Props {
  ...
  /** Título del modal */
  title: string
  /** Etiqueta de la entidad a crear/editar */
  entityLabel: string
  /** Texto del botón de confirmación */
  confirmText: string
  /** Lista de nombres existentes para validación de duplicados */
  ...
  /** Determina si se muestra el campo de nombre (útil si la entidad no lo requiere) */
...
/** Eventos emitidos por el modal genérico */
