\section{Manual de Referencia Técnica MDA-Audio-CIM-Machine}
...
En el CIM no se tiene por qué hablar de implementaciones concretas (osciladores, LFOs, filtros específicos) a bajo nivel, sino de \textbf{elementos} abstractos que capturan la intención del diseño de síntesis de la máquina.
