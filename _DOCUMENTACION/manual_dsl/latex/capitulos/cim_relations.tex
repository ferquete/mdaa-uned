\section{Manual de Referencia Técnica MDA-Audio-CIM-Relations-Machines}
...
En el CIM no se tiene por qué hablar de implementaciones concretas, sino de \textbf{elementos} abstractos que capturan la intención del diseño de síntesis de la máquina.
