...
- [src/mda-audio-cim.langium](src/mda-audio-cim.langium) -  The grammar definition of your language
- [src/mda-audio-cim-module.ts](src/mda-audio-cim-module.ts) - The dependency injection module of your language implementation. Use this to register overridden and added services.
- [src/mda-audio-cim-validator.ts](src/mda-audio-cim-validator.ts) - An example validator. You should change it to reflect the semantics of your language.
...
- [src/syntaxes/mda-audio-cim.monarch.ts](src/syntaxes/mda-audio-cim.monarch.ts) - Monarch based syntax highlighting instructions.
- [syntaxes/mda-audio-cim.tmLanguage.json](syntaxes/mda-audio-cim.tmLanguage.json) - Textmate based syntax highlighting instructions.
