# Manual de Referencia Técnica - PIM Relations

Este lenguaje permite orquestar las interconexiones granulares entre máquinas PIM (Modelo Independiente de Plataforma). A diferencia del nivel CIM, donde las relaciones son entre máquinas completas, el nivel PIM establece vínculos directos entre puntos de conexión y parámetros específicos.
