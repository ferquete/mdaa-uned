...
export const CIM_MACHINE_SCHEMA = {
  ...
  properties: {
    ...
    description: { type: 'string', minLength: 10, maxLength: 6000, description: 'Explicación del propósito de la máquina' },
    generators: {
      type: 'array',
      items: {
        type: 'object',
        ...
        properties: {
          ...
          description: { type: 'string', minLength: 10, maxLength: 6000, description: 'Explicación del propósito del generador' },
          params: { type: 'string' },
          sendTo: {
            type: 'array',
            items: {
    ...
    modificators: {
      ...
      items: {
        ...
        properties: {
          ...
          name: { type: 'string' },
          description: { type: 'string', minLength: 10, maxLength: 6000 },
          params: { type: 'string' },
          sendTo: {
            type: 'array',
            items: {
