    ...
    generators: {
      ...
      items: {
        ...
        properties: {
          ...
          id: { type: 'string', description: 'Identificador único del generador' },
          ...
          refs: {
            ...
            items: {
              ...
              properties: {
                id: { type: 'string', description: 'ID del componente referenciado' },
          ...
          rels: {
            ...
            items: {
              ...
              required: ['id', 'description'],
              properties: {
                id: { type: 'string', description: 'ID del componente relacionado' },
