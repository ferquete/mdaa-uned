...
export const PIM_MODIFIABLE_PARAMS: Record<string, string[]> = {
  ...
  envelope: ['attack', 'decay', 'sustain', 'release', 'delay', 'hold', 'curve'],
  frequency_filter: ['cutoff', 'resonance', 'filterType', 'slope', 'ping_pong'],
  reverb: ['roomSize', 'damping', 'decayTime', 'dryWet', 'ping_pong'],
  delay: ['delayTime', 'feedback', 'lowPassCutoff', 'highPassCutoff', 'dryWet', 'ping_pong'],
  distortion: ['drive', 'tone', 'outputLevel', 'distType', 'ping_pong'],
  chorus_flanger: ['rate', 'depth', 'feedback', 'mix', 'ping_pong'],
  compressor: ['threshold', 'ratio', 'attack', 'release', 'makeupGain', 'ping_pong'],
  equalizer: ['bandFrequency', 'bandwidth', 'gain', 'ping_pong'],
  mixer: ['inputs_number'],
  gain_pan: ['gain', 'pan']
};
