      ...
      <form @submit.prevent="handleUpdate" class="space-y-6">
        ...
        <div class="pt-6 flex items-center gap-4">
          <button 
            ...
            class="flex-1 bg-geist-fg text-geist-bg font-medium py-3 rounded-lg hover:opacity-90 active:scale-[0.98] transition-all disabled:opacity-30 disabled:cursor-not-allowed text-sm"
          >
          ...
          <button 
            type="button"
            @click="goBack"
            class="px-6 py-3 border border-geist-border rounded-lg text-sm font-medium hover:border-geist-fg transition-colors active:scale-[0.98]"
          >
            Volver
          </button>
        </div>
